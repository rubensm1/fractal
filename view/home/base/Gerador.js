...
Gerador = (function() {
    ...
    Gerador.prototype.teste = function() {
        ...
        motores.novoMotor(new Motor(planoG, planoPrincipal, motores.getPincel(), new Ponto(0, 150), INTERVALO_QUANT_PULSOS, fragPonts, COR, ESCALA - partEscala, 0.2, !SENTIDO), null, 1);
