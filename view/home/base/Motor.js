...
Motor = (function() {
    ...
    Motor.prototype.ligar = function(pulsante, hidePontos, startAt) {
...
/*
 ...
 motores.novoMotor( new Motor(planoPrincipal,planoPrincipal,motores.getPincel(),planoG) );
 motores.novoMotor( new Motor(planoG,planoPrincipal,motores.getPincel(),new Ponto(0,150), INTERVALO_QUANT_PULSOS, FRAGMENTOS, COR, 150 ));
 motores.novoMotor( new Motor(planoG,planoPrincipal,motores.getPincel(),new Ponto(0,150), INTERVALO_QUANT_PULSOS, FRAGMENTOS, COR, 150 ));
  */
